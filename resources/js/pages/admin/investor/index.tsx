...
export default function Investor() {
    const { props } = usePage<{ investors: PaginatedInvestor }>();
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                <div className="rounded-lg border">
                        ...
                        <TableBody>
                            {investors.map((investor) => (
                                <TableRow key={investor.id}>
                                    <TableCell className="text-center font-medium">{investor.nama_investor}</TableCell>
                    ...
                    <div className="px-4 py-2 text-sm text-gray-600">
                        Menampilkan {investorsPaginated.to} dari {investorsPaginated.total} investor
                    </div>
